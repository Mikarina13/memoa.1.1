...
export function PortraitGenerationInterface({ onPortraitsGenerated, onClose }: PortraitGenerationInterfaceProps) {
  const { user } = useAuth();
      ...
      <div className="bg-black/90 border border-white/20 rounded-xl p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-white font-[Orbitron]">Portrait Generation Studio</h2>
          </div>
          <button
            onClick={onClose}
          ...
          {activeTab === 'upload' && (
            <div className="space-y-6">
              ...
              <div className="bg-white/5 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-4">Upload Source Photo</h3>
                  ...
                  >
                    {sourceImage ? (
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          <p className="text-white text-lg mb-2">Upload a clear photo of your loved one</p>
