...
export function VoiceRecordingInterface({ onVoiceCloned, onClose }: VoiceRecordingInterfaceProps) {
  const { user } = useAuth();
  ...
  const openElevenLabsAffiliate = () => {
    window.open('https://elevenlabs.io/app/subscription?ref=memoa&code=WORLDSLARGESTHACKATHON-0bb0fa21', '_blank');
  ...
  const cloneVoiceWithElevenLabs = async () => {
    ...
    try {
      ...
      // Store voice ID in our database and update integration status
    ...
    >
      <div className="bg-black/90 border border-white/20 rounded-xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-white font-[Orbitron]">Voice Recording Studio</h2>
          <button
            onClick={onClose}
          ...
          {activeTab === 'record' && (
            <>
              ...
              <div className="bg-white/5 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-4">Record Your Voice</h3>
              ...
              <div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-lg p-6 border border-blue-500/30">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-white">ElevenLabs Voice Cloning</h3>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/5 rounded-lg p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-white">Connect Existing Voice</h3>
                </div>
