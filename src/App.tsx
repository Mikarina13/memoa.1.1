...
import { MemorialSpaceBuilderPage } from './pages/MemorialSpaceBuilderPage';
  ...
  return (
    <>
      ...
      <div className="w-full h-screen bg-[#111111]">
        <div 
          className={`fixed -top-4 left-1 flex items-center gap-1 z-10 cursor-pointer transition-opacity ${
        ...
        <a href="https://bolt.new" target="_blank" rel="noopener noreferrer">
          <img 
            src="https://i.imgur.com/vF3CgNV.png"
            alt="Bottom Logo"
            className="fixed bottom-4 right-4 w-14 opacity-50 z-10 hover:opacity-100 transition-opacity cursor-pointer"
          />
        </a>
        <div className="relative w-full h-full">
          ...
          <div className="absolute bottom-2 left-0 right-0 mx-auto w-fit bg-black/50 backdrop-blur-sm px-4 py-2.5 rounded-xl border border-white/10">
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/memorial-builder" element={<MemorialSpaceBuilderPage />} />
        <Route path="/memorial-builder/:spaceId" element={<MemorialSpaceBuilderPage />} />
